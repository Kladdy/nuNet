...
from tensorflow.keras.layers import GlobalAveragePooling3D, GlobalAveragePooling2D
...
if this_run_id == "0":
...
elif this_run_id == "1" or this_run_id == "2" or this_run_id == "3":
    # Conv2D block 1
    model.add(Conv2D(conv2D_filter_amount, (1, conv2D_filter_size), strides=(1, 1), padding='same', activation=activation_function, input_shape=(5, 512, 1)))
...
elif this_run_id == "4" or this_run_id == "5" or this_run_id == "6" or this_run_id == "7":
    # Conv2D block 1
    model.add(Conv2D(conv2D_filter_amount, (1, conv2D_filter_size), strides=(1, 1), padding='same', activation=activation_function, input_shape=(5, 512, 1)))
    ...
    if this_run_id == "4":
        model.add(Conv3D(32, (3, 3, 1), strides=(1, 1, 1), padding='same', activation=activation_function))
    elif this_run_id == "5":
        model.add(Conv3D(32, (5, 5, 1), strides=(1, 1, 1), padding='same', activation=activation_function))
    elif this_run_id == "6":
        model.add(Conv3D(32, (3, 3, 3), strides=(1, 1, 1), padding='same', activation=activation_function))
    elif this_run_id == "7":
        model.add(Conv3D(32, (5, 5, 5), strides=(1, 1, 1), padding='same', activation=activation_function))
...
#                               patience=es_patience-3, min_lr=0.000001, verbose=1)
