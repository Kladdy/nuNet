...
#             print("reshuffling")
        ...
        # np.random.shuffle(rand_ids) # DONT SHUFFLE THE EVENTS FOR THIS PLOTTING
        ...
        for i_batch in range(n_batches):
            ...
            # np.random.shuffle(rand_ids2) # DONT SHUFFLE THE EVENTS FOR THIS PLOTTING
            for i_noise in range(n_noise_iterations):
    ...
    def __new__(cls, file_id):
        return tf.data.Dataset.from_generator(
            ...
            output_shapes=((batch_size * n_noise_iterations, 5, 512, 1), (batch_size * n_noise_iterations, )),
            args=(file_id,)
        )